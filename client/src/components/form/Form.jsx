      ...
      <form className='form' onSubmit={handleSubmit}>
        <div className="form-lft">
          ...
          <div className="user">
            ...
            <input type="email" name="email" key="email" placeholder="Invernalia@gmail.com" value={userData.email} onChange={handleChange} />
            {errors.email && <p className="error">{errors.email}</p>}
          </div>

          <div className="pass">
            <label htmlFor="password">Contraseña</label>
            <input type="password" name="password" key="password" placeholder="Ingresa tu contraseña" value={userData.password} onChange={handleChange} />
